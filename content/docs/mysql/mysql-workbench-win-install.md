...
В списке выберем сам сервер баз данных, графическую у работы с базам данных **Workbench**, и консоль для работы с базой данных. Для добавления нужных элементов, выберите в левом списке и нажмите одинарную стрелку указывающую вправо, в итоге вы должны получить следующий набор:

![Untitled%203.png](Untitled%203.png)

Выбирайте самую последнюю версию из списка, в нашем случае это 8.0.23, если на момент установки у вас версия выше - выбирайте соответсвующую скаченному `mysql-installer-community-8.0.23.0.msi`
