...
требованиям в практическом задании.
{{< /hint >}}
...
практическое задание связано с ними. Дальнейшее прохождение
практического задания будет невозможно без обращения в
...
приступайте к выполнению практического задания.
